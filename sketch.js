...
var angle;persongroup,person2group,bulletgroup,carimg,car,cargroup,policeimg;
...
function spawnpolice() {
  police1 = createSprite(0,Math.round(random(100,357),20,20));
  police1.addImage(policeimg)
  police1.velocityX=Math.round(10,15);
  police1.scale=0.2
  
  police2 = createSprite(0,Math.round(random(150,350),20,20));
  police2.addImage(policeimg)
  police2.velocityX=Math.round(10,15);
  police2.scale=0.2
  police3 = createSprite(0,Math.round(random(200,300),20,20));
  police3.addImage(policeimg)
  police3.velocityX=Math.round(10,15);
  police3.scale=0.2
}
